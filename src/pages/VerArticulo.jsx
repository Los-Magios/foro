...
const VerArticulo = () => {
  return (
    <>
      ...
      <div className="container fondonegro mt-3">
        <div className="row">
          <div className="col-2">
          ...
          <div className="col-10">
            <div className="card">
              ...
              <p className="info-articulo">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Quisquam, voluptas saepe. Minima neque maiores incidunt voluptas
                a voluptatibus ratione, nisi dignissimos possimus culpa vero
                ...
                <div className="row align-items-center">
                  <div className="col-auto">
                    <div className="input-group">
                      ...
                      <h6 className="text-primary mx-3 mt-2">
                        Bordón Milagroz
                      </h6>
                    </div>
                  </div>
                  <div className="col-auto ms--2">
                    <p>
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                      Debitis iure illo explicabo aliquid in fuga corporis
                      maxime at porro eveniet rem et quasi reprehenderit
                      voluptas, hic modi fugit libero earum!
                    </p>
                  </div>
                </div>
              </li>
